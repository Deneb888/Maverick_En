...
//          }
        ...
        public void CheckFalsePositive(int iy)
        {
            ...
            for (int frameindex = 0; frameindex < numWells; frameindex++)
            {
                ...
                ratio_k *= Math.Pow(2, ct_diff * 0.1);      // ct diff 10 results in ratio credit double
                ...
                confi = ratio_k * 0.85 + (ratio_eff - 0.1) * 1.11 * 0.15; // Weighted average of 2 score, r generally range 0.19 to 0.65
